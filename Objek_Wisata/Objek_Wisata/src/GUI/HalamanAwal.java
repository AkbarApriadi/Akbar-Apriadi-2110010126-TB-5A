...
public class HalamanAwal extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel2.setIcon(new javax.swing.ImageIcon(getClass().getResource("/GUI/Awal.png"))); // NOI18N
        jPanel2.add(jLabel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, 780, 580));

        jMenu1.setText("Form Tampil");
        ...
        jMenuPelanggan.setText("Jenis Wisata");
    ...
    private void jMenuItem1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuItem1ActionPerformed
        ObjekWisata ObjekWisataFrame = new ObjekWisata();
        ObjekWisataFrame.setVisible(true);
        dispose();
    ...
    private void jMenuPelangganActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jMenuPelangganActionPerformed
        JenisWisata JenisWisataFrame = new JenisWisata();
        JenisWisataFrame.setVisible(true);
        dispose();
